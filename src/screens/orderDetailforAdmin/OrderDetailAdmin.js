        ...
        <SafeAreaView style={[AppStyles.container]}>
            <ImageBackground
                ...
                <View style={[AppStyles.center, SingleCollectionStyle.collectionDetail]}>
                    <Text style={SingleCollectionStyle.detailText}>Brand Name : {orderDetail && orderDetail.brandId.brandName}</Text>
...
export default connect(mapStateToProps, { getMeeting })(OrderDetailAdmin);